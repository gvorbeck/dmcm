...
//     /* Hide tables */
//     this.diceTable.current.style.display = this.attackTable.current.
// style.display = this.simpleTable.current.style.display = 'none';
...
//       /* This value is used multiple times so
// constructing it outside of the object becomes necessary. */
...
// These rolls handle Ability and Skill Checks. */
//       const roll = handleRoll(20);
//       const obj = {
//         title:    simple.title,
//         roll:     roll,
...
//     console.log(
//       'Dice Roll @' + clickDate.getHours()
// + ':' + clickDate.getMinutes() + ':' + clickDate.getSeconds() +
//       (obj.title ? '\nTitle: ' + obj.title : '') +
//       (obj.formula ? '\nFormula: ' + obj.formula : '') +
...
//   componentDidMount() {
//     setTimeout(() => {
//       /* This is delayed because some pages render their components AFTER <Layout/>
// and makes buttons not work if rendered after <Layout/>. */
...
//   componentDidUpdate() {
//     /* Runs again so that when searching
// , new results containing buttons are given event listeners. */
//     this.getButtons();
//   }
