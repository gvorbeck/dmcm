...
- name: Entrance
  ...
  content: |
    ...
    * Any dice formulas in text can be turned into buttons to roll from!
        * example: <Dice>d20</Dice>, <Dice>5d6</Dice>, it's so easy - <Dice>3d12+3</Dice>! It may be finicky sometimes. Make sure it isn't wrapped in HTML tags or at the end of a sentence. I'll work on this.
    #### Developments
...
* **Ceilings**. Ceilings are 10 feet high and are entirely unremarkable. <Dice>3d6-3</Dice>
